...
show_status() {
    ...
    echo -e "  Web Dashboard:           ${BLUE}http://devicebox.local${NC}"
    echo -e "  API Adresse:             ${BLUE}http://$(hostname -I | awk '{print $1}')${NC}"
    echo ""
    ...
    echo "    curl http://devicebox.local/health"
    echo "    curl http://devicebox.local/info"
    echo ""
